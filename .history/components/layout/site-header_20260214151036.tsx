    ...
    <header className="sticky top-0 z-40 border-b border-[#d6d6d6] bg-[#f3f3f3]/95 backdrop-blur">
      <div className="mx-auto flex max-w-[1280px] items-center justify-between gap-3 px-3 py-3 sm:px-5 lg:px-8">
        <div className="flex min-w-0 items-center gap-3 lg:gap-4">
          ...
          <button
            type="button"
            className="hidden min-h-11 items-center gap-2 rounded-xl border border-[#d6caef] bg-[#ece6fb] px-3 text-sm text-[#5d4299] transition duration-200 hover:-translate-y-0.5 hover:shadow-[0_10px_20px_rgba(201,74,137,0.16)] sm:inline-flex"
          >
        ...
        <div className="flex items-center gap-1.5 sm:gap-2">
          <Link href="/store" className="hidden rounded-md border border-[#c5b77e] bg-white px-2 py-1 text-[1.75rem] text-sm font-bold text-[#2c2c2c] transition duration-200 hover:-translate-y-0.5 hover:shadow-[0_10px_20px_rgba(201,74,137,0.16)] lg:inline-flex">
            <span>Get</span>
          ...
          <Link href="/wishlist" className="relative inline-flex h-10 w-10 items-center justify-center rounded-full text-[#262626] transition duration-200 hover:-translate-y-0.5 hover:bg-[#e5e5e5] hover:shadow-[0_8px_16px_rgba(201,74,137,0.12)]" aria-label="Wishlist">
            <Heart className="h-6 w-6" />
            {wishlistCount > 0 && <CountBadge value={wishlistCount} />}
          </Link>

          <Link href="/cart" className="relative inline-flex h-10 w-10 items-center justify-center rounded-full text-[#262626] transition duration-200 hover:-translate-y-0.5 hover:bg-[#e5e5e5] hover:shadow-[0_8px_16px_rgba(201,74,137,0.12)]" aria-label="Cart">
...
function IconLink({
  ...
  return (
    <Link href={href} aria-label={label} className="inline-flex h-10 w-10 items-center justify-center rounded-full text-[#262626] transition duration-200 hover:-translate-y-0.5 hover:bg-[#e5e5e5] hover:shadow-[0_8px_16px_rgba(201,74,137,0.12)]">
