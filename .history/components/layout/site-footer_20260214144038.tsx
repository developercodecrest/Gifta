      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-3">
          <section>
            ...
            <Link
              href="/store"
              className="mt-5 inline-flex min-h-11 w-full items-center justify-center rounded-sm bg-[#f7a4c8] px-5 text-sm font-semibold uppercase tracking-[0.08em] text-[#3f1f40] transition hover:bg-[#ffb7d5] sm:w-56"
            >
              Store Locator
            </Link>
          </section>
          ...
          <section>
            ...
            <form className="mt-4" action="#">
              <div className="flex overflow-hidden rounded-sm border border-white/30 bg-white/95">
                ...
                <button
                  type="submit"
                  className="inline-flex min-h-11 min-w-11 items-center justify-center bg-[#f7a4c8] px-3 text-xl text-[#3f1f40] transition hover:bg-[#ffb7d5]"
