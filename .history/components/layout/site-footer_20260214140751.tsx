    ...
    <footer className="mt-20 border-t border-border bg-surface">
      <div className="border-b border-border bg-background">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4 px-4 py-6 sm:px-6 lg:px-8">
          <div className="space-y-1">
            ...
            <h3 className="text-xl font-bold tracking-tight text-[#24438f]">Need help choosing the perfect gift?</h3>
          </div>
          <div className="grid w-full gap-2 sm:flex sm:w-auto sm:flex-wrap">
            <Link href="/store" className="rounded-lg bg-primary px-4 py-2 text-center text-sm font-semibold text-primary-foreground transition hover:opacity-90">
              Shop now
            </Link>
            <Link href="/store?category=Corporate" className="rounded-lg border border-border bg-white px-4 py-2 text-center text-sm font-semibold transition hover:bg-surface">
              Corporate gifting
            </Link>
          </div>
        </div>
      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 md:grid-cols-2 lg:grid-cols-4 lg:gap-10 lg:px-8">
        <div className="rounded-2xl border border-border bg-background p-5">
          <h3 className="text-2xl font-bold tracking-tight text-primary">Gifta</h3>
      ...
      <div className="border-t border-border bg-background">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-center gap-3 px-4 py-4 text-center text-xs text-muted sm:justify-between sm:text-left sm:px-6 lg:px-8">
