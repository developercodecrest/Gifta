          ...
          <nav className="mx-auto grid max-w-[1280px] gap-2 sm:grid-cols-2 lg:grid-cols-4">
            {navItems.map((item) => (
              <Link
                ...
                className={cn(
                  "inline-flex min-h-11 items-center rounded-md border border-[#efb7cc] bg-white/75 px-3 text-sm font-medium text-[#2f2f2f] shadow-[0_2px_8px_rgba(201,74,137,0.08)] transition hover:bg-white",
