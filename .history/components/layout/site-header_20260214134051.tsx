    ...
    <header className="sticky top-0 z-40 border-b border-border bg-background/95 backdrop-blur">
      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2">
          {isStorePage && (
            <Link href="/store" className="hidden rounded-md border border-border p-2 transition hover:bg-surface sm:inline-flex">
              <Search className="h-4 w-4" />
            </Link>
          )}
          <Link href="/wishlist" className="relative rounded-md border border-border p-2 transition hover:bg-surface">
            <Heart className="h-4 w-4" />
            {wishlistCount > 0 && <CountBadge value={wishlistCount} />}
          </Link>
          <Link href="/cart" className="relative rounded-md border border-border p-2 transition hover:bg-surface">
