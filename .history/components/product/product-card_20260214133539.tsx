      ...
      <div className="space-y-3 p-4">
        <div className="flex items-start justify-between gap-2">
          <div>
            ...
            <Link href={`/store/${product.slug}`} className="mt-1 block text-base font-semibold transition hover:text-primary">
              {product.name}
            </Link>
          </div>
          <button
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg bg-foreground px-4 py-2.5 text-sm font-medium text-background transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
        >
