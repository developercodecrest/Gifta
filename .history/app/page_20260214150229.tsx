          ...
          {quickFilters.map((item, index) => {
            ...
            return (
              <Link
                key={item.label}
                href={item.href}
                className="group relative flex min-h-28 flex-col items-center justify-center gap-3 px-4 text-center transition duration-200 hover:-translate-y-0.5 hover:shadow-[0_10px_20px_rgba(201,74,137,0.18)]"
              >
