  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[minmax(0,2fr)_minmax(320px,1fr)]">
      <section className="rounded-2xl border border-[#edd2d9] bg-white p-4 sm:p-6">
        <div className="rounded-xl bg-linear-to-r from-[#ffeef2] via-[#ffe6ec] to-[#ffdce5] px-4 py-4 sm:px-5">
          <h1 className="text-2xl font-bold tracking-tight text-[#24438f] sm:text-3xl">Secure Checkout</h1>
          <p className="mt-1 text-sm text-[#2f3a5e]/80">Complete your order details and place your gift in minutes.</p>
        </div>
      ...
      <aside className="h-fit overflow-hidden rounded-2xl border border-[#edd2d9] bg-linear-to-b from-[#fff1f4] to-[#ffe9f0] p-4 sm:p-5 lg:sticky lg:top-24">
        <h2 className="text-3xl font-semibold text-[#24438f]">Order Summary</h2>
        <ul className="mt-4 space-y-2 text-sm">
          {mapped.map((item) => (
            <li key={item.product.id} className="flex justify-between gap-2">
              <span className="max-w-[72%] text-[#2f3a5e]/80">
        ...
        <dl className="mt-4 space-y-2 border-t border-[#edd2d9] pt-4 text-sm">
          ...
          <div className="flex justify-between text-3xl font-bold text-[#24438f]">
            <dt>Total</dt>
            <dd className="whitespace-nowrap">{formatCurrency(total)}</dd>
          </div>
        </dl>
