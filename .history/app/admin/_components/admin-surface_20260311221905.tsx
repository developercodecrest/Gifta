        ...
        {stats?.length ? (
          <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
            {stats.map((stat) => (
              ...
              >
                <p className="text-xs font-semibold uppercase tracking-[0.24em] text-[#74655c]">{stat.label}</p>
...
export function AdminEmptyState({
  ...
  return (
    <div className="rounded-[1.6rem] border border-dashed border-border bg-background/50 px-6 py-10 text-center">
      ...
      <p className="mx-auto mt-2 max-w-xl text-sm leading-6 text-[#5f5047]">{description}</p>
