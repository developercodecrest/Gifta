    ...
    <div className="space-y-4">
      ...
      {!sorted.length ? (
        ...
        <div className="space-y-3">
          {sorted.map((order) => (
            <Card key={order.id} className="border-border/70 bg-background/80"><CardContent className="flex min-h-44 items-start justify-between gap-3 p-4">
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {sorted.map((order) => (
            <Card key={order.id} className="border-border/70 bg-background/80"><CardContent className="flex min-h-52 flex-col space-y-2 p-5">
              <p className="font-semibold">{order.id}</p>
