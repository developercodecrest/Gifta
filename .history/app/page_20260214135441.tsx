...
export default function Home() {
  ...
  return (
    <div className="space-y-10">
      ...
      <section className="rounded-3xl border border-border bg-white px-4 py-8 sm:px-6">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-6 text-sm font-medium text-muted">
          <button type="button" className="text-[#24438f]">New</button>
          <button type="button" className="hover:text-[#24438f]">Top rated</button>
          <button type="button" className="hover:text-[#24438f]">Trending</button>
          <button type="button" className="hover:text-[#24438f]">Best offer</button>
        </div>

        <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {demoProducts.map((item) => (
            <article key={item.id} className="overflow-hidden rounded-xl border border-border bg-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
