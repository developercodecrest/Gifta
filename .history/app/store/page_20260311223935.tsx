    ...
    <div className="space-y-7 sm:space-y-8">
      ...
      <section className="grid gap-4 xl:grid-cols-[300px_minmax(0,1fr)] xl:items-start">
            ...
            <form className="grid gap-3.5" action="/store" method="get">
              ...
              <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-1">
                <div className="space-y-2">
                  ...
                  <select id="store-category" name="category" defaultValue={category} className="app-input-surface min-h-12 w-full rounded-2xl px-3 py-2 text-sm">
                ...
                <div className="space-y-2">
                  ...
                  <select id="store-sort" name="sort" defaultValue={sort} className="app-input-surface min-h-12 w-full rounded-2xl px-3 py-2 text-sm">
              ...
              <div className="space-y-2">
                ...
                <select id="store-id" name="storeId" defaultValue={storeId} className="app-input-surface min-h-12 w-full rounded-2xl px-3 py-2 text-sm">
              ...
              <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-1">
                <div className="space-y-2">
                  ...
                  <Input id="store-min-price" type="number" min={0} name="minPrice" defaultValue={minPrice} placeholder="0" className="app-input-surface h-12 rounded-2xl" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="store-max-price">Max price</Label>
                  <Input id="store-max-price" type="number" min={0} name="maxPrice" defaultValue={maxPrice} placeholder="5000" className="app-input-surface h-12 rounded-2xl" />
                </div>
              </div>
              ...
              <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-1">
                <div className="space-y-2">
                  ...
                  <Input id="store-min-rating" type="number" min={0} max={5} step={0.1} name="minRating" defaultValue={minRating} placeholder="4.0" className="app-input-surface h-12 rounded-2xl" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="store-tag">Tag</Label>
                  <Input id="store-tag" name="tag" defaultValue={tag} placeholder="same-day, premium..." className="app-input-surface h-12 rounded-2xl" />
                </div>
              </div>

              <Label className="app-input-surface flex min-h-12 items-center gap-2 rounded-2xl px-4 py-3 text-sm font-normal">
        ...
        <div className="space-y-4">
          <div className="app-data-panel flex flex-col gap-3 rounded-[1.4rem] px-4 py-3.5 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p className="text-sm text-[#5f5047]">Showing {result.items.length} of {result.meta.total} products</p>
              <p className="mt-1 text-xs text-[#74655c]">Vendor-first comparison with a denser, easier-to-scan layout.</p>
            </div>
