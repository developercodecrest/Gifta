  ...
  return (
    <div className="space-y-7 sm:space-y-8">
      <header className="space-y-2">
        <h1 className="text-2xl font-bold sm:text-3xl">Gift Store</h1>
        <p className="text-sm text-muted sm:text-base">Find the perfect premium gift with smart search and filters.</p>
      </header>
      ...
      <form className="grid gap-3 rounded-2xl border border-border bg-surface p-4 md:grid-cols-5" action="/store" method="get">
        <input
          ...
          className="min-h-11 rounded-lg border border-border bg-white px-3 py-2 text-sm md:col-span-2"
        />

        <select name="category" defaultValue={category} className="min-h-11 rounded-lg border border-border bg-white px-3 py-2 text-sm">
        ...
        <select name="sort" defaultValue={sort} className="min-h-11 rounded-lg border border-border bg-white px-3 py-2 text-sm">
        ...
        <label className="flex min-h-11 items-center gap-2 rounded-lg border border-border bg-white px-3 py-2 text-sm">
          <input type="checkbox" name="stock" value="1" defaultChecked={inStock} />
          In stock only
        </label>

        <button className="min-h-11 rounded-lg bg-foreground px-4 py-2 text-sm font-semibold text-background md:col-span-5" type="submit">
          Apply filters
        </button>
      </form>
