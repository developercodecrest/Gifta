      ...
      <header className="surface-mesh soft-shadow rounded-4xl border border-white/70 p-6 sm:p-8 lg:p-10">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm text-muted-foreground sm:text-base">Keep favorite gifting ideas together, compare them calmly, and move the best picks into cart when you are ready.</p>
          </div>
      ...
      {wishlistProducts.length === 0 ? (
        <Card className="rounded-4xl border-dashed border-[#e5c9bb] bg-white/70">
          <CardContent className="p-10 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">Explore the redesigned storefront and save the gifts you want to revisit.</p>
        ...
        <>
          <section className="rounded-4xl border border-white/60 bg-white/75 px-5 py-4 text-sm text-muted-foreground">
