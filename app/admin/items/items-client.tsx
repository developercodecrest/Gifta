                  ...
                  <tbody>
                    {filtered.map((item) => (
                      <tr key={item.id} className="border-t border-border/60 align-top">
                        ...
                        <td className="px-4 py-4 text-muted-foreground">{formatCurrency(item.bestOffer?.price)}</td>
                        <td className="px-4 py-4 text-muted-foreground">{item.minOrderQty ?? 1} to {item.maxOrderQty ?? 10}</td>
                        <td className="px-4 py-4">
                  ...
                  <CardContent className="space-y-4 p-5">
                    ...
                    <div className="rounded-2xl border border-border/70 bg-card px-4 py-3">
                      <div className="flex items-center justify-between gap-2">
                        <span className="text-xs uppercase tracking-[0.22em] text-muted-foreground">Best offer</span>
