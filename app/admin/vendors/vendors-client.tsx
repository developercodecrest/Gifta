              ...
              <tbody>
                {sorted.map((vendor) => (
                  <tr key={vendor.id} className="border-t border-border">
                    ...
                    <td className="px-4 py-3 text-muted-foreground">{vendor.primaryCategory ?? "-"}</td>
                    ...
                    <td className="px-4 py-3">{vendor.itemCount}</td>
                    <td className="px-4 py-3">{vendor.offerCount}</td>
                    <td className="px-4 py-3">
            ...
            <Card key={vendor.id}>
              <CardContent className="flex flex-wrap items-start justify-between gap-3 p-4">
                <div className="space-y-1.5">
                  ...
                  <p className="text-sm text-muted-foreground">{vendor.primaryCategory ?? "Uncategorized"}{vendor.primarySubcategory ? ` • ${vendor.primarySubcategory}` : ""}</p>
                  <p className="text-sm text-muted-foreground">Rating {vendor.rating.toFixed(1)} • Items {vendor.itemCount} • Offers {vendor.offerCount}</p>
                </div>
