...
export default async function AdminRolesPage() {
  const role = await ensureAdminAccess("roles");
  ...
  return (
    <div className="space-y-6">
      <header className="rounded-xl border border-border bg-card p-5">
        ...
        <p className="mt-1 text-sm text-muted-foreground">System roles: sadmin, storeOwner, rider, user. Active role: {roleLabels[role]}.</p>
      </header>
