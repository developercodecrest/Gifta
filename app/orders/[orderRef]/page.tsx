      ...
      <header className="surface-mesh soft-shadow rounded-4xl border border-white/70 p-6 sm:p-8 lg:p-10">
        ...
        <div className="mt-4 flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-3 text-sm text-muted-foreground">Placed on {formatDate(order.placedAt)} · Last update {formatDate(order.lastUpdatedAt)}</p>
          </div>
        ...
        <Card className="glass-panel rounded-4xl border-white/60">
          <CardContent className="space-y-4 p-6">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="rounded-3xl border border-white/70 bg-white/70 p-4 text-sm text-muted-foreground">
...
function InfoPill({
  ...
  return (
    <div className="rounded-4xl border border-white/60 bg-white/75 p-5">
