    ...
    <div className="space-y-6">
      <Card className="surface-mesh soft-shadow mx-auto max-w-4xl overflow-hidden rounded-4xl border-white/70 text-center">
        <CardContent className="p-8 sm:p-10 lg:p-12">
          ...
          <div className="mt-6 rounded-4xl border border-white/70 bg-white/80 p-5">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            ...
            <Button asChild variant="outline" className="border-[#efc9ba] bg-white/85">
...
function SuccessPill({
  ...
  return (
    <div className="rounded-3xl border border-white/70 bg-white/75 p-4 text-left">
