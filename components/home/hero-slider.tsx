...
const slides: HeroSlide[] = [
  {
    ...
    secondaryHref: "/products?sort=rating",
  ...
  },
  {
    ...
    ctaHref: "/products?tag=same-day",
    secondaryLabel: "View premium picks",
    secondaryHref: "/products?tag=luxury",
  ...
  },
  {
    ...
    ctaHref: "/products?tag=personalized",
    secondaryLabel: "See relationship gifts",
    secondaryHref: "/products?q=couple",
