...
export function Footer() {
  return (
    <footer className="mt-20 bg-[#1d1114] text-[#fff6ee]">
      <div className="page-gutter py-14 sm:py-16">
        ...
        <div className="mt-8 grid gap-8 xl:grid-cols-[1.15fr_0.85fr]">
          <section className="rounded-[2rem] bg-white/[0.045] p-6 shadow-[0_20px_50px_-38px_rgba(0,0,0,0.55)] backdrop-blur sm:p-8">
            <div className="flex flex-wrap items-start justify-between gap-5">
              ...
              <Button asChild className="bg-white text-[#1d1114] hover:bg-[#ffe8d7]">
                <Link href="/search">
                  Explore catalog
          ...
          <section className="rounded-[2rem] bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.03))] p-6 shadow-[0_20px_50px_-38px_rgba(0,0,0,0.55)] backdrop-blur sm:p-8">
...
function HighlightCard({
  ...
  return (
    <div className="rounded-[1.4rem] bg-white/84 p-4 shadow-[0_16px_30px_-26px_rgba(113,52,39,0.22)]">
